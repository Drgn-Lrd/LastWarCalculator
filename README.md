...
## Version 4.2.7: Light Theme Color Customization

This version incorporates a user-requested aesthetic update to the calculator's light theme.

* **Light Theme Color Palette:**
* The default light theme colors have been updated to a "cool slate" palette, providing a distinct and customized visual experience for users who prefer the light mode.

---

## Version 4.2.8: Conditional Completion Date Display

This version enhances the "Completion Time" display logic based on user feedback, providing more relevant information.

* **Conditional Date in Completion Time:**
* The date is now displayed in the "Completion Time" field **only if the calculated time to completion is greater than 24 hours**.
* For completion times less than or equal to 24 hours, only the time (e.g., "2:30 PM PDT") will be shown, improving conciseness for short-term estimates.

---

## Version 4.2.9: Precise Indiana Time Zone Handling

This version addresses a specific historical and modern inconsistency with the Indiana time zone, based on user inquiry.

* **Indiana (Eastern Standard Time) Override:**
* Implemented a specific override for `America/Indiana/Indianapolis` within the time zone handling functions.
* This ensures that Indiana's time is **always treated as UTC-5 (Eastern Standard Time)** and displays with the **EST abbreviation**, accurately reflecting its non-observance of Daylight Saving Time. This resolves potential discrepancies arising from browser `Intl.DateTimeFormat` interpretations.
